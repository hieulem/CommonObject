function[] = Re_VOC2007_cafferefnet(cls,K,distance)
...
option.CNNrespath =fullfile(option.data,'trainval','CNNres_cafferefnet');
option.netmeta = 'netmeta_cafferefnet.mat';
...
option.basepath =  fullfile(option.data,option.dataset,'cafferefnet');
