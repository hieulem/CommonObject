addpath(fullfile('..','dataset','VOCdevkit2012'));
addpath(fullfile('..','dataset','VOCdevkit2012','VOCcode'));
VOCinit;
...
save('VOC_val_info.mat','recs','gtids');
...
for clsi =1:20
    cls = VOCopts.classes{clsi};
    path = fullfile('VOC2012','val','imlist',cls);
       mkdir(path);
