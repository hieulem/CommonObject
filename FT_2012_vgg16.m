function[] = FT_2012_vgg16(cls,K,kd,iter)
...
option.CNNrespath =fullfile(option.data,'trainval','CNNres_vgg16');
option.netmeta = 'netmeta_vgg16.mat';
...
option.basepath =  fullfile(option.data,option.dataset,'vgg16');
